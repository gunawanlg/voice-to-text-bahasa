...
if __name__ == "__main__":
    ...
    available_files = [
        f"{k.replace('npz', 'mp3')}" for k, v in file_nonavailability_dict.items() if not v
    ]

    confirmation = str(input(f"You're going to delete {len(available_files)} files, this change is \
